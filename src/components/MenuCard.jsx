...
const MenuCard = ({ item, refCallback }) => (
  <div
    ref={refCallback}
    className="menu-card group relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden transition-all duration-500 hover:border-[#e8a045]/40 hover:bg-white/8 hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(232,160,69,0.15)]"
  >
    ...
    <div className="relative h-48 flex items-center justify-center overflow-hidden bg-linear-to-b from-white/5 to-transparent">
      <img
        src={item.img}
        alt={item.name}
      ...
      />
      <div className="absolute inset-0 bg-linear-to-t from-[#1a1209] via-transparent to-transparent" />
    </div>
